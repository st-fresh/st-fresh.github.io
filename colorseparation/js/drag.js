...
//     var mouse = myState.getMouse(e);
//     myState.addShape(new Rectangle(mouse.x - 10, mouse.y - 10, 20, 20, 'rgba(0,255,0,.6)'));
//   }, true);
...
//   s.(addShapenew Rectangle(40,40,50,50)); // The default is gray
