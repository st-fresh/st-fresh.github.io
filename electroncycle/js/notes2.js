function startTutorial() {
    ...
    function drawLabels() {
        ...
        // console.log(_labelson); //check this log to see how labelson changes

        if(_labelson) {
            switch(_activestate) {
                case 0: 
                // _labelA.style.opacity = 1;
                    // _labelA.style.visibility = "visible";
                ...
                // _labelA.style.opacity = 1;
                    ...
                    // labelVisibility();
                    // _labelA.style.opacity = 1; //if labelson true then it enters switch and sets opacity to 1
                    // TweenLite.to(_labelA, 1, {alpha: 1});
                    TweenLite.set(_labelA, {alpha: 1});
        }
        else{
        // TweenLite.to(_labelA, 1, {alpha: 0});
                    TweenLite.set(_labelA, {alpha: 0});
            // _labelA.style.opacity = 0;  //if labelson is false then hits this else statement which sets opacity to 0
        }
    }
    ...
    //     tl.to(_labelA, 1, {x:0, onComplete: 
    //         function() {
    //             if(!labelShow) {
    //                 _labelA.style.visibility = "hidden";
    //                 labelShow = true;
    //             }
    //         }
    //     });
